...
{
    public class XssParallelValidationTest
    {
        ...
        {
            var result = Validator.ValidateForXssScriptParallel("hello");
        ...
        {
            var result = Validator.ValidateForXssScriptParallel("<alert>Hi!!!</alert>");
            Assert.AreEqual(result, false);
        }
        ...
        public void test_input_of_type_complexclass_for_xss_validation_with_injection()
        {
            ...
            var result = Validator.ValidateForXssScriptParallel<TestComplexClass2>(objtestComplexClass1.Dept.FirstOrDefault());
            Assert.AreEqual(result, false);
        }
